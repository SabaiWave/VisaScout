    ...
    <div style={{ background: 'var(--color-bg-base)', minHeight: '100vh' }} className="relative">
      ...
      <main className="relative z-10 max-w-[760px] mx-auto px-6 py-16">
        ...
        <div className="space-y-8" style={{ color: 'var(--color-text-secondary)', lineHeight: 1.75 }}>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: 'var(--color-text-primary)', fontFamily: 'var(--font-mono)' }}>6. Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3" style={{ color: 'var(--color-text-primary)', fontFamily: 'var(--font-mono)' }}>11. Contact</h2>
            <p>
              Privacy questions?{' '}
