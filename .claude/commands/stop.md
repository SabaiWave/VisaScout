...
[Bullet list of anything this session that felt manual, repetitive,
or like it should be automatic. If nothing, write "None."
Be specific — "had to manually set max_tokens for resolver"
